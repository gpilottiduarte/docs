...
Escolha o Modo Sandbox para explorar recursos em um ambiente simulado e seguro. Se necessário, consulte o artigo [Sobre o Modo Sandbox](/v3-33/docs/pt/cloud-security-about-sandbox-mode).
...
Escolha esta opção para uma experiência abrangente completa, onde você terá a capacidade de convidar outras pessoas para sua organização e tenants. Para saber mais sobre organizações, consulte o artigo [Sobre a arquitetura do Cloud Security](/v3-33/docs/pt/cloud-security-about-cloud-securitys-architecture). 
