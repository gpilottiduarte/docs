...
3. No [Relatório de recomendações](/v3-33/docs/pt/cloud-entitlements-recommendations-report), busque pelo tipo específico de recomendação que você deseja.
...
3. No [Relatório de identidades](/v3-33/docs/pt/cloud-entitlements-identities-report), localize a identidade específica para a qual deseja ver recomendações.
...
2. Selecione **Recomendações**.
3. No [Relatório de recomendações](/v3-33/docs/pt/cloud-entitlements-recommendations-report), clique no **ícone de download** no canto superior direito da lista.
