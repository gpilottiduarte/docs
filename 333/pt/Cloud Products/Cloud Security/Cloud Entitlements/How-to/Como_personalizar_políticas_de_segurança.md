...
Para informações detalhadas sobre as políticas de Segurança do Cloud Entitlements, consulte o artigo sobre [Políticas de segurança](/v3-33/docs/pt/cloud-entitlements-security-policies).
...
::: (info) (Info)
 Consulte o artigo sobre [Critérios de Segurança para recomendações](/v3-33/docs/pt/cloud-entitlements-security-criteria-for-recommendations) para obter mais informações sobre os critérios específicos de cada CSP.
:::
