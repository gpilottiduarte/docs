...
:::(Info) (Nota)
Os critérios utilizados pelo Cloud Entitlements para avaliar a segurança de seus ambientes em nuvem variam conforme o provedor de nuvem específico. Acesse o artigo [Critérios de segurança para recomendações](/v3-33/docs/pt/cloud-entitlements-security-criteria-for-recommendations) para saber mais.
:::
...
Você pode [personalizar suas políticas de segurança](/v3-33/docs/pt/cloud-entitlements-how-to-customize-security-policies) para se adequar às necessidades do seu negócio, utilizando os seguintes níveis de criticalidade:
