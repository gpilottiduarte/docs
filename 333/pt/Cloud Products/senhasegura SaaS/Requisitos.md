...
Para uma implementação e operação bem-sucedidas das soluções da senhasegura nos modelos SaaS padrão e Private SaaS, é fundamental atender a requisitos técnicos e operacionais específicos. Cumprir esses pré-requisitos garantirá desempenho ótimo, segurança e satisfação dos usuários.

## Requisitos Gerais para Ambos os Modelos SaaS

### Largura de Banda Compatível para Carga de Trabalho

Os clientes que utilizam os modelos **senhasegura SaaS** padrão ou **Private SaaS** devem ter uma largura de banda de rede compatível com suas cargas de trabalho pretendidas. Uma largura de banda adequada é crucial para a transferência eficiente de dados entre o ambiente do cliente e a infraestrutura de hospedagem, minimizando a latência e melhorando a experiência do usuário. Considerações principais incluem:
...
A [instalação do agente Network Connector](/v3-33/docs/pt/network-connector-install) é crucial para os modelos SaaS padrão e Private SaaS. Este agente, que será fornecido pela senhasegura, desempenha um papel fundamental em estabelecer uma conexão segura e confiável com a aplicação hospedada. Considerações importantes incluem:
...
O licenciamento e a implementação devem estar em conformidade com os **[termos da Microsoft](https://learn.microsoft.com/en-us/windows-server/remote/remote-desktop-services/rds-client-access-license)**. Atente-se que a senhasegura não lida com licenças; os clientes precisam adquirir licenças diretamente da Microsoft.
...
Cumprindo esses requisitos, as organizações podem garantir uma operação consistente e eficaz das soluções SaaS padrão e Private da senhasegura, maximizando os benefícios de proteção e gerenciamento de identidade.