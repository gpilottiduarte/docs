...
* [Create a user in the senhasegura platform](https://docs.senhasegura.io/v3-33/docs/user-management-add-system-administrator)NoteThe senhasegura user must have a registered e\-mail;
* [Add a user in AWS through Cloud IAM](https://docs.senhasegura.io/v3-33/docs/cloud-iam-add-user);ImportantUsers imported from AWS can not perform remote access.
...
* [Create a user in the senhasegura platform](https://docs.senhasegura.io/v3-33/docs/user-management-add-system-administrator);Note The senhasegura user must have a registered e\-mail.
* [Add a user in AWS through Cloud IAM](https://docs.senhasegura.io/v3-33/docs/cloud-iam-add-user);ImportantUsers imported from AWS can not perform JIT access.
