...
5. Select **Renew certificate**.
    5.1 If you select **Generate the request and sign** and then click **Save**, the application will save the renewal request and open the **[signature form](/v3-33/docs/certificates-flow-how-to-sign-request)**. 
