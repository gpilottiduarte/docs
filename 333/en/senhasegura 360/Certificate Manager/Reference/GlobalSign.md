...
InfoFor further registration information, refer to the article [How to configure Authorities](/v3-33/docs/certificate-manager-settings-how-to-configure-authorities).## External authority
