...
3. In the [Recommendations report](/v3-33/docs/cloud-entitlements-recommendations-report), find the specific type of recommendation you're interested in.
...
<!-- Fix link and step 5 is blank -->
To view the recommendations, follow these steps:

1. Go to the left-side menu within Cloud Entitlements.
2. Select **Identities**.
3. In the [Identities report](/v3-33/docs/cloud-entitlements-identities-report), locate the specific identity for which you want to view recommendations.
...
2. Select **Recommendations**.
3. In the [Recommendations report](/v3-33/docs/cloud-entitlements-recommendations-report), click the **Download icon** on the top right of the list.
