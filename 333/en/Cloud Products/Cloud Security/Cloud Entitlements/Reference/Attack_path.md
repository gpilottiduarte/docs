...
By clicking on any field from the report, you’ll access the [Identity details](https://docs.senhasegura.io/docs/cloud-entitlements-attack-path#identity-details-modal) modal for the selected principal.
