...
:::(Info) (Note)
The criteria used by Cloud Entitlements to evaluate the security of your cloud environments vary depending on the specific cloud provider. Visit the [Security Criteria for Recommendations](/v3-33/docs/cloud-entitlements-security-criteria-for-recommendations). 
:::
...
You can [customize your security policies](/v3-33/docs/cloud-entitlements-how-to-customize-security-policies) to align with the specific requirements of your business needs using the following criticality levels:
